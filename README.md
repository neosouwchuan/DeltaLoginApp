# DeltaLoginApp
This is my attempt at solving a problem of signing into OCS Service Term digitally.
For those that are not from Singapore, all Singaporean males are drafted for up to 2 years after reaching 16(or later if they defer due to studies). During conscription, some are sent to OCS for training, and OCS is made up of 3 terms of which service terms is about 3 months. During my 3 months in Delta Wing, I contributed to my Wing by trying to introduce digital signing in because signing in by hand took a lot of time, and often resulted in long lines of cadets queueing for the book.
The requirements set out by my instructors are as follows:
...
No method to cheat the signing in system.
...
<p>
Funny how things work, I have recently enrolled into King's College London for Computer Science. Their attendance tracking system is very similar to mine, see link below.
  https://www.kcl.ac.uk/politics-economics/assets/student-user-guide-for-venio.pdf
</p>
